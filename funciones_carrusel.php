...
try {
	if ($_SERVER['REQUEST_METHOD'] == "GET") {
		...
		if (isset($_GET["item_2"]))
			$item_2 = trim(htmlentities($_GET["item_2"]));
		if (isset($_GET["item_3"]))
			$item_3 = trim(htmlentities($_GET["item_3"]));
		...
		// echo "<br>normal: " . $qryParticipantes;
		...
		// echo "<br><b>AND</b>: " . $qryParticipantes;

...
try {
	...
	function consigueFranjaDIP($db){
            ...
            P.votos_nulos as 'NULOS', P.votacion_total as 'TOTAL_VOTOS_ASENTADOS', (P.votacion_total + P.votos_nulos  + P.votos_cand_no_reg) as 'TOTAL_VOTOS_CALCULADO',
            C.lista_nominal as 'LISTA_NOMINAL', P.representantes_votaron as 'REPRESENTANTES_PP_CI', CASE WHEN P.inconsistencia =1 THEN 'ILEGIBLE' 
            ...
            CASE WHEN P.contabilizar = 'T' THEN '1' ELSE '0'
            END as 'CONTABILIZADAS', 'F' as 'MECANISMO_TRASLADO', A.md5_img_dmr as 'CODIGO_INTEGRIDAD',
		...
		CASE WHEN P.capturado_por=1 THEN 'MOVIL' 
